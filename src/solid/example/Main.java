...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        orders.add(new Customer("William Walters", 75.34, new DiscountSale()));
        orders.add(new Customer("Susan Smothers", 24.12, new BaseSale()));
        orders.add(new Customer("Jessica Johnson", 273.93, new LiquidationSale()));
        orders.add(new Customer("Richard Ricardo", 171.42, new DiscountSale()));
